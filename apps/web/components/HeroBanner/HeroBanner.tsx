...
const HeroBanner = (): JSX.Element => (
  <div className="relative">
    ...
    <Layout className="py-12 text-center md:px-8 md:py-20 lg:px-12 lg:py-32">
      <h1
        className={clsx(
      ...
      <p className="text-shadow-sm px-8 text-xs text-white sm:text-sm md:text-base lg:px-16 lg:text-lg">
